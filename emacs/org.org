...
#+begin_src elisp
  (setq org-todo-keyword-faces
        '(("IDEA" :foreground "purple" :weight bold)
          ...
          ("SCHEDULED" :foreground "brown" :weight bold)
...
#+begin_src elisp
  (setq org-todo-state-tags-triggers
        '(("CANCELLED" ("CANCELLED" . t))
          ...
          ("SCHEDULED" ("MEETING" . t) ("WAITING") ("HOLD") ("CANCELLED"))
  ...
  (setq org-capture-templates
        '(("i" "idea" entry (file org-default-notes-file)
          ...
          ("r" "respond" entry (file org-default-notes-file)
           "* NEXT Respond to %? on \nSCHEDULED: %t\n%U\n%a\n"
           :clock-in t :clock-resume t)
          ("s" "scheduled meeting" entry (file org-default-notes-file)
           "* SCHEDULED %? :MEETING:\n%^T"
           :clock-keep t)
  ...
  (defun rf/org-agenda-set-agenda-files ()
    ...
    (setq org-agenda-files
          (delete-dups
           (mapcar
            'expand-file-name
            (append (when (functionp 'rf/org-agenda-get-local-agenda-files)
                      (rf/org-agenda-get-local-agenda-files))
