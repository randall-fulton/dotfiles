...
Show folders before files in =dired=.
#+begin_src elisp
...
** Email
Based on [[https://michal.sapka.me/2023/notmuch/][Mical Sapka's]] blog post.
...
#+begin_src elisp
  (use-package notmuch-indicator
    ...
    (notmuch-indicator-args '((:terms "tag:gh-pr-todo" :label "pr:"))))
#+end_src
...
#+begin_src elisp :tangle no
  (setq org-todo-keywords
        '((sequence "TODO" "NEXT" "WAITING" "|" "DONE" "CANCELLED" "MEETING")))
#+end_src
  ...
  (defun rf/configure-org ()
    ...
    (let* ((variable-tuple
      ...
      (custom-theme-set-faces
       ...
       `(org-document-title ((t (,@headline ,@variable-tuple :underline nil)))) ; :height 2.0
