...
#+begin_src elisp
  (defun rf/format-week-id ()
    "Create string identifying current week in format '<YEAR> Week
  <WEEK NUM>'. Weeks start on Monday."
    (concat
     (format-time-string "%Y")
     " Week "
     (format-time-string "%W")))

  (defun rf/org-roam-goto-weekly ()
  ...
  dailies."
    ...
    (let* ((org-roam-directory (expand-file-name org-roam-dailies-directory
                                                 org-roam-directory))
           (weekly-file-id (rf/format-week-id))
